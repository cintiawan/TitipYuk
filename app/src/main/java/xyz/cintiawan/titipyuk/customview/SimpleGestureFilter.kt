...
class SimpleGestureFilter internal constructor(private val context: Activity, private val listener: SimpleGestureListener) : SimpleOnGestureListener() {
    ...
    override fun onSingleTapConfirmed(arg: MotionEvent): Boolean {
        ...
        if (this.mode == MODE_DYNAMIC) {        // we owe an ACTION_UP, so we fake an
            arg.action = ACTION_FAKE      //action which will be converted kotaTujuan an ACTION_UP later.
