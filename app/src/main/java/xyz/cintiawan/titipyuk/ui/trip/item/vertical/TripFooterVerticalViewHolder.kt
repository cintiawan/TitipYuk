...
class TripFooterVerticalViewHolder(v: View) : RecyclerView.ViewHolder(v) {
    ...
    companion object {
        fun create(retry: () -> Unit, parent: ViewGroup): TripFooterVerticalViewHolder {
            val view = LayoutInflater.from(parent.context)
                    .inflate(R.layout.item_footer_vertical, parent, false)
            view.btn_retry.setOnClickListener { retry() }

            return TripFooterVerticalViewHolder(view)
        }
    }
}