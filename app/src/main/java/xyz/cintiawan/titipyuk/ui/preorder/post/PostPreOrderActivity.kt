...
import xyz.cintiawan.titipyuk.databinding.ActivityPostPreOrderBinding
...
import xyz.cintiawan.titipyuk.ui.varian.VarianCallback
import xyz.cintiawan.titipyuk.ui.slider.ImageFullActivity
import xyz.cintiawan.titipyuk.util.afterTextChanged

class PostPreOrderActivity : BaseActivity(), VarianCallback {
    @Inject lateinit var factory: ViewModelFactory
    private lateinit var viewModel: PostPreOrderViewModel

    private lateinit var binding: ActivityPostPreOrderBinding
    private lateinit var loadingDialog: LoadingDialog
    private lateinit var errorDialog: ErrorDialog
    private lateinit var confirmationDialog: ConfirmationDialog
    private lateinit var successDialog: SuccessDialog
    private lateinit var imgMenu: AlertDialog
    private lateinit var varianForm: VarianBottomSheetFragment
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        super.inject()
        binding = DataBindingUtil.setContentView(this, R.layout.activity_post_pre_order)

        setSupportActionBar(binding.toolbar)
        supportActionBar?.title = "Post Pre Order"
    ...
    override fun setVarian(nama: String, harga: Double) {
        viewModel.setVarian(nama, harga)
    }

    private fun initViewModel() {
        viewModel = ViewModelProviders
                .of(this, factory)
                .get(PostPreOrderViewModel::class.java)
        ...
        viewModel.kategoriItem.observe(this, Observer {
            ...
            binding.txtKategori.threshold = 0
    ...
    private fun initBinding() {
        ...
        binding.btnTambahVarian.setOnClickListener { loadVarianSheet() }
    }
    ...
    private fun loadVarianSheet() {
        varianForm = VarianBottomSheetFragment(this)
        varianForm.show(supportFragmentManager, VarianBottomSheetFragment::class.simpleName)
    }
