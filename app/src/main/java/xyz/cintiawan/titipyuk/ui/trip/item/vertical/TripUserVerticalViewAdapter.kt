...
class TripUserVerticalViewAdapter(private val retry: () -> Unit) : PagedListAdapter<TripItem, RecyclerView.ViewHolder>(RequestDiffCallback) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when(holder) {
            is TripDataVerticalViewHolder -> holder.bind(getItem(position), position)
    ...
    companion object {
        val RequestDiffCallback = object : DiffUtil.ItemCallback<TripItem>() {
